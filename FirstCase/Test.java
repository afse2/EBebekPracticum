public class Test {
    ...
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee("Mehmet",10000,45,2010);
       ...
       //Employee with a salary of greater than 1000 and less than 40 hours of work and a hiring year of greater than 10
        ...
        Employee emp2 = new Employee("Alex", 9000,37,2010);
        ...
        Employee emp3 = new Employee("Mehmet Fatih", 1000, 40, 2017);

        System.out.println(emp3);

        //Employee with a invalid hireyear
        Employee emp5= new Employee("leyla", 13350,36,2022);
        System.out.println(emp5);

        //Employe with a name has special character
        Employee emp4 = new Employee("Ahmer?",10000,42,2013);
